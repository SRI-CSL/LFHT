...
\begin{lemma}[Order of old and new arrays]
  \begin{equation*}
    \begin{array}{l}      
...
\begin{lemma}[If an array is not full then the arrays after that  must be empty]
  \begin{equation*}
\begin{array}{l}        
...
\begin{lemma}[Number of migrations cannot exceed the number of entries in an array]
  \begin{equation*}
\begin{array}{l}        
...
\begin{lemma}[Sizes of each array]
  \begin{equation*}
\begin{array}{l}        
...
\begin{lemma}[New array cannot be assimilated]
  \begin{equation*}
\begin{array}{l}        
...
\begin{lemma}[New array cannot migrate entries]
  \begin{equation*}
\begin{array}{l}      
...
\begin{lemma}[Old array always exceeds the occupancy threshold]
  \begin{equation*}
\begin{array}{l}        
...
\begin{lemma}[If an array is assimilated no more migrations are possible]
  \begin{equation*}
\begin{array}{l}        
...
\begin{lemma}[At least one thread at the initial state after migration]
  \begin{equation*}
    \begin{array}{l}
...
\begin{lemma}[Value for paid\_tax before having copies]
  \begin{equation*}
\begin{array}{l}        
...
\begin{lemma}[Relationship between revenue and paid\_tax]
    \begin{equation*}
\begin{array}{l}      
...
\begin{lemma}[Relationship between posted, pending, paid\_tax and did\_not\_pay]
  \begin{equation*}
    \begin{array}{l}      
...
\begin{lemma}[Upper bound of the number of entries for all old arrays]
  \begin{equation*}
\begin{array}{l}    
...
\jorge{The numbers in Figure~\ref{sal-results} is with 3 tables. If we
  increase the number of tables then we need to increase the parameter
  $K$.}
